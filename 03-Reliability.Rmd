...
list_of_alphas <- 
  list(
    org   = cronbach(dta, vars_hwes_org),
    unit  = cronbach(dta, vars_hwes_unit),
    comm  = cronbach(dta, vars_communication),
    coll  = cronbach(dta, vars_collaboration),
    resp  = cronbach(dta, vars_respect_by),
    mskil = cronbach(dta, vars_skills_manager),
    askil = cronbach(dta, vars_skills_admin)
